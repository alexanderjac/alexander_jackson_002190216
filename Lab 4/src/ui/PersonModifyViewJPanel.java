 ...
 */
public class PersonModifyViewJPanel extends javax.swing.JPanel {
    ...
    public PersonModifyViewJPanel(PersonDirectory listOfPerson) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("View or Modify Person");
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        // TODO add your handling code here:
        int flag_count = 0;
        for(int i=0; i<this.listOfPerson.getListOfPerson().size(); i++) {
if(txtViewssn.getText().equals(Long.toString(this.listOfPerson.getListOfPerson().get(i).getSsn()))) {
flag_count = 1;
txtViewName.setText(this.listOfPerson.getListOfPerson().get(i).getName());
txtViewAge.setText(Integer.toString(this.listOfPerson.getListOfPerson().get(i).getAge()));
txtViewSex.setText(this.listOfPerson.getListOfPerson().get(i).getSex());
txtViewAddress.setText(this.listOfPerson.getListOfPerson().get(i).getAddress());
txtViewPhoneNumber.setText(Long.toString(this.listOfPerson.getListOfPerson().get(i).getPhoneNumber()));
break;
}
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(txtViewssn.getText().equals(Long.toString(this.listOfPerson.getListOfPerson().get(i).getSsn()))) {
            flagPoint=1;
            this.listOfPerson.getListOfPerson().remove(this.listOfPerson.getListOfPerson().get(i));
...
flagPoint = 1;
 ...
 if(flagPoint == 0) {
Person newPerson = new Person(name, ssn, address, age, sex, phoneNumber);
this.listOfPerson.getListOfPerson().set(i, newPerson);
